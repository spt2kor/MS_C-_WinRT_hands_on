...
namespace winrt::WeatherData_App::implementation
{
    ...
    winrt::event_token WeDataViewModel::PropertyChanged(Windows::UI::Xaml::Data::PropertyChangedEventHandler const& value)
    {
    ...
    void WeDataViewModel::WeDataModified(bool WeDataModified)
    {
        _WeDataModified = WeDataModified;
        this->m_propertyChanged(*this, PropertyChangedEventArgs(L"MainWeData"));
    }
