...
namespace winrt::WinRTStaticLibObserver::implementation
{
    ...
    MyObserverAutoRevoke::MyObserverAutoRevoke()
        ...
        , m_CmdTokenMap(winrt::single_threaded_map<winrt::hstring, winrt::WinRTStaticLibObserver::EventToken>())
    {
    ...
    winrt::WinRTStaticLibObserver::EventToken MyObserverAutoRevoke::Register(winrt::hstring const& cmdString, UpdateOnDataChange const& func)
    {
        Log(string("reg@cmd:" + to_string(cmdString)));
        return m_ObserverSingleton.AddEventHandler(cmdString, func);
    }

    void MyObserverAutoRevoke::DeRegister(winrt::hstring const& cmdString, winrt::WinRTStaticLibObserver::EventToken const& token_value)
    {
    ...
    {
        Map map_cmdVsToken = winrt::single_threaded_map<winrt::hstring, winrt::WinRTStaticLibObserver::EventToken>();
