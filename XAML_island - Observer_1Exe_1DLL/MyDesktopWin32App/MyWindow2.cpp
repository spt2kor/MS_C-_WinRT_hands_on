...
/*
void UpdateVoiceData(Windows::Foundation::IInspectable const& sender, Windows::UI::Xaml::RoutedEventArgs const& e) {

}*/
//========================================================================
auto TestCodeExperimental()
{
    winrt::MyUWPApp::VAObservable vaObservable;
    Log("<Reg_T2>");

    event_token token2 = vaObservable.NotifyOnDataChange(
        [] (const winrt::MyUWPApp::PODData& _value) {
        Log(string( "[T2]Received:" + to_string(_value.m_msg()) ));
        }
    );
    Sleep(500);
    Log("<send update from T2>" );
    
    Sleep(500);

    winrt::MyUWPApp::PODData data;
    data.m_msg(L"_T2_Changed_");
    vaObservable.SetData(data);
    
    /*
    Log("going to set the data 2 ");

    winrt::MyUWPApp::PODData data1;
    data1.m_msg(L"_@Notify_2");
    vaObservable.SetData(data1);
    */

    Sleep(2000);
    Log("<remove T2>");

    vaObservable.NotifyOnDataChange(token2);
    Sleep(2000);
    /*
    Log("set the data completed");

    Log("going to set the data 3 ");

    winrt::MyUWPApp::PODData data2;
    data2.m_msg(L"_@Notify_3");
    vaObservable.SetData(data2);
    */
    //========================================
    
    winrt::MyUWPApp::MyTestClass obj1{ nullptr };
    obj1 = winrt::MyUWPApp::MyTestClass();
    auto value1 = obj1.GetValue();
    auto instance_count = winrt::MyUWPApp::MyTestClass::GetInstanceCount();

    winrt::MyUWPApp::MyTestClass obj2{ obj1};
    obj2 = obj1;
    auto value2 = obj2.GetValue();
    instance_count = winrt::MyUWPApp::MyTestClass::GetInstanceCount();


    winrt::MyUWPApp::MyTestClass obj3{ 100};
    auto value3 = obj3.GetValue();
    instance_count = winrt::MyUWPApp::MyTestClass::GetInstanceCount();


    winrt::MyUWPApp::MyTestClass obj4{ nullptr};//nullptr_t
    obj4 = obj2;
    auto value4 = obj4.GetValue();
    instance_count = winrt::MyUWPApp::MyTestClass::GetInstanceCount();


    return value1 + instance_count; //dummy op
}
//========================================================================
